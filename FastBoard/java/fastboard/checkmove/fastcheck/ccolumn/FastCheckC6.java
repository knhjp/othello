 ...
 */
public class FastCheckC6 implements FastCheck {
    private boolean[][] fastCheckCalcArray;

    public FastCheckC6(boolean[][] fastCheckCalcArray) {
        this.fastCheckCalcArray = fastCheckCalcArray;
    }

    @Override public boolean isValidMove(FastBoardLines lines) {
        return
                fastCheckCalcArray[2][lines.c1_c8] ||
                fastCheckCalcArray[5][lines.a6_h6] ||
                fastCheckCalcArray[2][lines.a4_e8] ||
                fastCheckCalcArray[5][lines.a8_h1];
    }
}